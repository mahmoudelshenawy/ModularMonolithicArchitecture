...
namespace Module.Employees.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230712001729_UpdateEmployeeTable")]
            ...
            modelBuilder.Entity("Module.Employees.Core.Entities.Employee", b =>
                {
                    ...
                    b.HasOne("Module.Employees.Core.Entities.Branch", null)
                        .WithMany("Employees")
                    ...
                    b.HasOne("Module.Employees.Core.Entities.Department", null)
                        .WithMany("Employees")
